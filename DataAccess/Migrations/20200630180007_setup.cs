        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConsoleId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Game_Consoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Game_Consoles_Consoles_ConsoleId",
                        column: x => x.ConsoleId,
                        principalTable: "Consoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Game_Consoles_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Game_Consoles_ConsoleId",
                table: "Game_Consoles",
                column: "ConsoleId");

            migrationBuilder.CreateIndex(
                name: "IX_Game_Consoles_GameId",
                table: "Game_Consoles",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_Game_Genres_GameId",
                table: "Game_Genres",
                column: "GameId");
